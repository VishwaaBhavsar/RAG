...
class SentenceTransformersEmbeddingError(RuntimeError):
    """Raised when sentence-transformers embeddings cannot be generated."""
...
class SentenceTransformersEmbeddingProvider(BaseEmbeddingProvider):
    """Generate document/query embeddings with sentence-transformers."""

    def __init__(self, model_name: str = "sentence-transformers/all-MiniLM-L6-v2") -> None:
        self.config = SentenceTransformersEmbeddingConfig(model_name=model_name)
        self._model = None
    ...
    def _load_model(self):
        ...
        try:
            ...
            raise SentenceTransformersEmbeddingError(
